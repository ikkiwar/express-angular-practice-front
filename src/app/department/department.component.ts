...
DepartmentWithoutFilter:any = [];
  ...
  createClick(){
    ...
    this.http.post(environment.API_URL+'department',val).subscribe(res => { alert(res.toString());
    this.refreshList();
    })
  }
  ...
  updateClick(){
    ...
    this.http.put(environment.API_URL+'department',val).subscribe(res => { alert(res.toString());
    this.refreshList();
    })
  }
